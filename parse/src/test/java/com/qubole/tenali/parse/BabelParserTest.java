...
public class BabelParserTest {
    ...
    public void testSimpleLateralView() throws Exception {
        String command = "select name, myq from table1 lateral_view_explode(qual, gual) q as myq1, myq2 ;select name, myq from table1 lateral_view_explode(qual, gual) q as myq1, myq2";
    ...
    public void testComplexJoinQuery3() throws Exception {
        String command = "\n\n--ujfbkwefuefwkbf wkjfbkwqbfkb\n-- jewfboef ewnfowenf eofneqwofn qwjfbqofb wqiofhqowfinoni\n" +
    ...
    public void testSelect() throws Exception {
        ...
        SqlCommandTestHelper.parsePrestoQuery(query);
    }
