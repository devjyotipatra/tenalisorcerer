...
public class TablesVisitorTest {

    private String getResults(List<String> tables) {
    ...
    public void testSimpleJoinQuery() throws Exception {
        ...
        String result = "RSTORE.CLUSTER_NODES, RSTORE.QUERY_HISTS";
        List<List<String>> tables = SqlCommandTestHelper.getTables(command);

        assertEquals(getResults(tables.get(1)), result.replace(",", "").replace(" ", ""));
    }
    ...
    public void testComplexJoinQuery1() throws Exception {
        ...
        assertEquals(getResults(tables.get(0)), result.replace(",", "").replace(" ", ""));
    ...
    public void testComplexJoinQuery3() throws Exception {
        ...
        String result = "PROCESSED_V2.SPARK, RSTORE.QUERY_HISTS, RSTORE.SPARK_COMMANDS";
        List<List<String>> tables = SqlCommandTestHelper.getTables(command);
    ...
    public void testComplexCTASQuery() throws Exception {
        ...
        String result = "AVANT_BASIC.ACCOUNT_DATEAVANT_BASIC.AUTO_REFINANCE_ATTEMPTSAVANT_BASIC.CUSTOMER_APPLICATIONSAVANT_BASIC.HARD_SECURED_ATTEMPTSAVANT_BASIC.LOANSAVANT_BASIC.LOAN_TASKSAVANT_BASIC.PAYMENTSAVANT_BASIC.PAYMENT_TRANSACTIONSDW_REF.FINANCIAL_STATEMENT_INDICATORSDW_TEMP_SWAP.TRANSACTIONS";
        List<List<String>> tables = SqlCommandTestHelper.getTables(command);
